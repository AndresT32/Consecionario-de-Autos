...
def run_seeder():
    ...
    try:
        ...
        existing_admin = db.query(Usuario).filter(Usuario.nombre_usuario == admin_username).first()
        ...
        if not existing_admin:
            ...
            logger.info("Usuario Administrador ya se encuentra presente en la base de datos (idempotencia cumplida).")
